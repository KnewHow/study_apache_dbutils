package org.apache.commons.dbutils.test;
...
public class TxQueryRunnerTest {
    ...
    @Test
    public void testQueryStringResultSetHandlerOfTObjectArray() throws SQLException {
        String sql ="insert into test values(?,?,?,?)";
        Object[][] params = {{3,123,"2017-12",323},{4,123,"2017-12",323}};
